...
| **6 View Tabs** | Dashboard, Agent Detail, Tasks, Logs, Office, Settings |
...
```
⬡ my-project-swarm │ Dashboard │ Agent Detail │ Tasks │ Logs │ Office │ Settings
┌──────────────────┐┌─────────────────────┐┌──────────────────────────┐
...
| `1`-`6` | Switch view tab (Dashboard, Agent Detail, Tasks, Logs, Office, Settings) |
...
6. **Settings** — Interactive settings form (language, theme, verbosity, etc.)
...
| **6 Görünüm Sekmesi** | Panel, Ajan Detay, Görevler, Loglar, Ofis, Ayarlar |
...
6. **Ayarlar (6)** — Etkileşimli ayarlar formu (dil, tema, detay seviyesi vb.)
